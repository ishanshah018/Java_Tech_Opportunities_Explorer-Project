...
public class UserService extends User {
    ...
    public void techAssessment(User a) {
        System.out.println("============================== Tech Assessment ===============================");
        String[][] questions = {
        ...
        String[] ans = { "C", "A", "B", "C", "B", "C", "A", "A", "B", "B", "A", "C", "A", "A", "B", "C", "A", "B", "B",
                "C" };
        int cnt = 0; // This variable keeps track of the current question number.

        // Looping Through Questions and User Input:
        // This nested loop iterates through each line within a question (question text
        // and answer options).
        for (String[] question : questions) {
            ...
            /*
             * Checks if the question numberis less than 5 and if the user's answer matches
             * the correct answer
             * for this question If true, increments the Programming Skills Marks
             */
            ...
            /*
             * Similar if statements follow the same structure, checking for question number
             * ranges
             * 5-9-> Sys_and_Net_marks
             * 10-14-> sw_dev_marks
             * 15-19-> hw_embeded_sys_marks
             * and incrementing corresponding category marks
             * if the user's answer matches the correct one.
             */
        ...
        // Displaying Results and Logging:

        System.out.println("------------------------------------- Result -----------------------------------");
        System.out
                .println("Programming Skills: " + Prog_skills_marks + "/5  Systems and Networking: " + Sys_and_Net_marks
                        + "/5   Software Development Practices: " + sw_dev_marks + "/5  Hardware and Embedded Systems: "
                        + hw_embeded_sys_marks
                        + "/5");
        Timestamp eventTime = Timestamp.from(Instant.now());
        /*
         * Prints the user's scores for each category along with the maximum marks for
         * each
         */

        a.skillAssessmentResultLog.push("Date/Time: " + eventTime + " Programming Skills: " + Prog_skills_marks
                + "/5  Systems and Networking: " + Sys_and_Net_marks
                + "/5   Software Development Practices: " + sw_dev_marks + "/5  Hardware and Embedded Systems: "
                + hw_embeded_sys_marks
                + "/5");
        generateEvaluationStatements(Prog_skills_marks, Sys_and_Net_marks, sw_dev_marks, hw_embeded_sys_marks);
        DatabaseUtil.updatingSkillAssessmentResultLog(a, Prog_skills_marks, Sys_and_Net_marks, sw_dev_marks,
                hw_embeded_sys_marks);
    }
    ...
    public void interestProfiling() {
        System.out.println("=============Tech-Curious ? Find Your Perfect Tech Path=================");
        int passion;
        int interest;
        ...
        giveRecommendations(interest, passion); /*
                                                 * Calls the giveRecommendations()
                                                 * method to provide recommendations
                                                 * based on the user's interest and passion.
                                                 */
    }
    ...
    public static void giveRecommendations(int interest, int passion) {
         ...
         * Defines a recommendations map to store pre-defined recommendations for
         * various combinations of interest and passion.
         * -------------------------------------------------------------------------
         * Retrieves the recommendation based on the provided interest and passion
         * values.
         */
        ...
        // I put this some matching interest-passion Keys in HashMap

        // If same to same interst-passion key will match than it will go to else part
        String key = interest + "-" + passion;
        String recommendation = recommendations.get(key);

        /*
         * If the recommendation is null, it means there isn't a pre-defined
         * recommendation for the given combination of interest and passion.
         */
        if (recommendation == null) {
            ...
            // /If a recommendation is found, it will be used directly.
            System.out.println(
                    "-----------------------------------------------------------------------------------------");
            System.out.println("Based on your choices, here are some recommendations: ");
            System.out.println("Interest: " + getInterestDescription(interest));
    ...
    public static String getInterestDescription(int interest) {
        switch (interest) {
            ...
            case 2:
                return "Developing Websites and Applications";
            case 3:
                return "Developing Game Applications";
            case 4:
                return "Security and Ethical Hacking";
            case 5:
                return "Managing Stored Data on Cloud";
            case 6:
    ...
    public static String getPassionDescription(int passion) {
        switch (passion) {
            case 1:
                return "Working with large datasets to find trends and insights";
            case 2:
                return "Building interactive and user-friendly web interfaces";
            case 3:
                return "Creating immersive and entertaining digital experiences";
            case 4:
                return "Protecting systems and networks from cyber threats";
            case 5:
                return "Managing and optimizing data storage in remote servers";
            case 6:
                return "Developing intelligent systems that can learn and adapt";
            case 7:
                return "Designing and programming autonomous machines";
            default:
                return "Unknown Passion";
        }
    }
    ...
    public void personalityAssessment(User a) {
        ...
        // Statements representing personality aspects.
        String[] QUESTIONS = {
        ...
        // Corresponding personality traits assessed.
        String[] TRAITS = {
                "Analytical Thinking",
                "Attention to Detail",
                "Problem Solving",
        ...
        // Potential career paths aligned with each trait
        String[][] CAREERS = {
